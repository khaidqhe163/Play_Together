        ...
        <>
            <Modal show={show} onHide={close} centered ref={modalCreate}>
                <Modal.Header>
                    ...
                    {
                        stage === 1 && <span id='next-stage' onClick={() => setStage(2)}>Tiếp theo</span>
                    }
                    {
                        stage === 2 && <span id='share-post' >Chia sẻ</span>
                    }
                ...
                </Modal.Header>
                {
                    stage === 0 && (
                        <div className='create-img-input' ref={inputImage}>
                            ...
                            <input type='file' style={{ display: "none" }} ref={inputFile} multiple accept='video/*' onChange={(e) => handleImageChange(e)} />
                        </div>
                    )}
                {
                    stage > 0 && (
