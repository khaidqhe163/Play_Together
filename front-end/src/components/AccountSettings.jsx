...
export default function AccountSettings() {
    ...
    const { isAccountDropdownOpen, isPlayerDropdownOpen } = useSelector(selectDropdownState);
    ...
    const handlePlayerClick = () => {
        dispatch(togglePlayerDropdown());
    };

    return (
        <div style={containerStyle}>
            <div>
                <p style={headingStyle} onClick={handleAccountClick}>
                ...
                <p style={headingStyle} onClick={handlePlayerClick}>
                    <div style={{ display: "flex", alignItems: "center" }}>
